...
inputf = 'cc.txt'
input_path = inputf.split('.')[0]+'r.txt'
raster,header = makearray(inputf)
#raster = filters.applygaussian(input_path, 1, 0.5 ,int(header[0]), int(header[1]))
raster = filters.applymedian(input_path,3,int(header[0]), int(header[1]))
rasterize(raster,inputf, header)
